      ...
      <section className="footer-cta">
        <Container>
          <Row className="align-items-center">
            <Col xs="12" lg="auto" className="footer-cta-text-wrap">
              <span className="footer-cta-text">
                Let's Talk
                <span className="footer-cta-icon" aria-hidden>
            ...
            <Col xs="12" lg="auto" className="footer-cta-btn-wrap">
              <Link to="/contact" className="footer-btn-consultation">
                Book A Consultation
          ...
          <Row className="g-4 g-lg-5">
            <Col xs="12" md="6" lg="3">
              <div className="footer-brand">
                <img src={logoImg} alt="CloudKodeForm Technologies" className="footer-logo-img" />
            ...
            <Col xs="12" md="6" lg="3">
              ...
              <address className="footer-contact">
                <p className="footer-address">Mau, Uttar Pradesh, India - 221603</p>
                <p className="footer-tel">
                  <a href="tel:+919650792424">+91 965 079 2424</a>
                </p>
                <p className="footer-email">
                  <a href="mailto:info@cloudkodeform.com">info@cloudkodeform.com</a>
                </p>
              </address>
            </Col>
          </Row>
